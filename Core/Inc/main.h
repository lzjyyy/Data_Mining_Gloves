...
#define Relay_Ctrl_5_Pin GPIO_PIN_5
#define Relay_Ctrl_5_GPIO_Port GPIOA
#define Relay_Ctrl_4_Pin GPIO_PIN_6
#define Relay_Ctrl_4_GPIO_Port GPIOA
#define Relay_Ctrl_3_Pin GPIO_PIN_7
#define Relay_Ctrl_3_GPIO_Port GPIOA
#define Relay_Ctrl_2_Pin GPIO_PIN_4
#define Relay_Ctrl_2_GPIO_Port GPIOC
#define Relay_Ctrl_1_Pin GPIO_PIN_5
#define Relay_Ctrl_1_GPIO_Port GPIOC
...
#define Relay_Ctrl_0_Pin GPIO_PIN_7
#define Relay_Ctrl_0_GPIO_Port GPIOE
